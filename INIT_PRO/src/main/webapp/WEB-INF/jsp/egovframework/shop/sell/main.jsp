	...
	if(userInput=="1234")
		{
           ...
           location.href = "<c:url value='/initProductList.do'/>";
...
<div class="container">
<a href="javascript:fn_init_productList();" style="float: right;">관리자 로그인</a>
	<br/>
<div class="container logo" style="float:center;">
		<a href="/INIT_PRO/"><img src="${pageContext.request.contextPath}/images/logo.png" width="1000" height="200" /></a>
	</div>
	
         <div class="form-group" style="float: left;">
            <span class="btn btn-default cal-btn">
                        <a href="initProductListUser.do" style=" font-size:20px;">전체 상품 보러가기</a>
           </span>
         </div>
          ...
          <%--  <div id="search" class="form-group" style="float: right;">
                 <div class="col-sm-10" style="width:75%;">
                  ...
                  <div class="col-sm-10"  style="width:25%;">
                       <span class="btn btn-default cal-btn">
                           <a href="initProductListUser.do">검색</a>
                       </span>
                    </div>
...
<ul class="bxslider">
      ...
      <li><a><img src="${pageContext.request.contextPath}/upload/${mainImg[0].imgAddress}" style="width:auto; height:500px;" >
      <input type='hidden' id='IDX' name='IDX' value="${mainImg[0].prdNum}"></a></li>
      <li><a><img src="${pageContext.request.contextPath}/upload/${mainImg[1].imgAddress}" style="width:auto; height:500px;">
      <input type='hidden' id='IDX' name='IDX' value="${mainImg[1].prdNum}"></a></li>
      <li><a><img src="${pageContext.request.contextPath}/upload/${mainImg[2].imgAddress}" style="width:auto; height:500px;">
      <input type='hidden' id='IDX' name='IDX' value="${mainImg[2].prdNum}"></a></li>
      <li><a><img src="${pageContext.request.contextPath}/upload/${mainImg[3].imgAddress}" style="width:auto; height:500px;">
      <input type='hidden' id='IDX' name='IDX' value="${mainImg[3].prdNum}"></a></li>
</ul>
</div>
...
<div align="center">
	...
	<div class='card'>
		<a href='#this' name='title'>
			<div class='imgswap'style = "position:relative; top:50%; left:50%; transform: translate(-50%, -60%);" >
			 <c:if test="${productList[0].imgAddress!=null }">
									<img src='${pageContext.request.contextPath}/upload/${productList[0].imgAddress}'  width='auto' height='230'> 
									<img src='${pageContext.request.contextPath}/upload/${productList[0].imgAddress}'  width='auto' height='230'>
				</c:if>
				<c:if test="${productList[0].imgAddress==null }">
			     	<img src='${pageContext.request.contextPath}/images/noimg.jpg' width='200' height='auto'> 
			     	<img src='${pageContext.request.contextPath}/images/noimg.jpg' width='200' height='auto'>
				</c:if>
			 </div>
			...
			<br>
			<div style="position: absolute;  left:50%; transform: translate(-50%, 0%); bottom: 20px;">
			<font class='font1'style="line-height: inherit;">${productList[0].prdName}</font>  
			<input type='hidden' id='IDX' name='IDX' value="${productList[0].prdNum}">
			</div>
			</a>
			</div>
	<div class='card'>
		<a href='#this' name='title'>
			<div class='imgswap'style = "position:relative; top:50%; left:50%; transform: translate(-50%, -60%);" >
			 <c:if test="${productList[1].imgAddress!=null }">
									<img src='${pageContext.request.contextPath}/upload/${productList[1].imgAddress}' width='auto' height='230'> 
									<img src='${pageContext.request.contextPath}/upload/${productList[1].imgAddress}' width='auto' height='230'>
				</c:if>
				<c:if test="${productList[1].imgAddress==null }">
			     	<img src='${pageContext.request.contextPath}/images/noimg.jpg' width='200' height='auto'> 
			...
			<br>
			<div style="position: absolute;  left:50%; transform: translate(-50%, 0%); bottom: 20px;">
			<font class='font1'style="line-height: inherit;">${productList[1].prdName}</font>
			  
			<input type='hidden' id='IDX' name='IDX' value="${productList[1].prdNum}">
			</div>
			</a>
			</div>
	...
	<div class='card'>
		<a href='#this' name='title'>
			<div class='imgswap'style = "position:relative; top:50%; left:50%; transform: translate(-50%, -60%);" >
			 <c:if test="${productList[2].imgAddress!=null }">
									<img src='${pageContext.request.contextPath}/upload/${productList[2].imgAddress}'  width='auto' height='230'> 
									<img src='${pageContext.request.contextPath}/upload/${productList[2].imgAddress}'  width='auto' height='230'>
				</c:if>
				<c:if test="${productList[2].imgAddress==null }">
			     	<img src='${pageContext.request.contextPath}/images/noimg.jpg' width='200' height='auto'> 
			...
			<br>
			<div style="position: absolute;  left:50%; transform: translate(-50%, 0%); bottom: 20px;">
			<font class='font1'style="line-height: inherit;">${productList[2].prdName}</font>  
			<input type='hidden' id='IDX' name='IDX' value="${productList[2].prdNum}">
			</div>
			</a>
			</div>
	...
	<div class='card'>
		<a href='#this' name='title'>
			<div class='imgswap'style = "position:relative; top:50%; left:50%; transform: translate(-50%, -60%);" >
		 	<c:if test="${productList[3].imgAddress!=null }">
									<img src='${pageContext.request.contextPath}/upload/${productList[3].imgAddress}' width='auto' height='230'> 
									<img src='${pageContext.request.contextPath}/upload/${productList[3].imgAddress}'  width='auto' height='230'>
				</c:if>
				<c:if test="${productList[3].imgAddress==null }">
			     	<img src='${pageContext.request.contextPath}/images/noimg.jpg' width='200' height='auto'> 
			...
			<br>
			<div style="position: absolute;  left:50%; transform: translate(-50%, 0%); bottom: 20px;">
			<font class='font1'style="line-height: inherit;">${productList[3].prdName}</font>
			<input type='hidden' id='IDX' name='IDX' value="${productList[3].prdNum}">
			</div>
			</a>
			</div>
...
function fn_openBoardDetail(obj) {
	...
	comSubmit.setUrl("<c:url value='/initSellListUser.do' />"); // url설정
	comSubmit.addParam("selectedId", obj.parent().find("#IDX").val()); // IDX; id로 값을넘김
	comSubmit.submit();
...
function fn_selectNewItemList(pageNo) {
	...
	comAjax.setUrl("<c:url value='/main.do' />");
...
function fn_selectNewItemListCallback(data) {
	...
	if (total == 0) {
		...
		var str = "";
		$.each(data.mainImg, function(key, value) {
							var imgpath = "<img src='${pageContext.request.contextPath}/upload/"+value.imgAddress+"' width='400' height='400'>"
