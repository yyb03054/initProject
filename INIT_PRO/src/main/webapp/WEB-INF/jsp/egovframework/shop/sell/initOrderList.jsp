...
<script src="<c:url value='/js/jqgrid/jquery.contextmenu.js'/>" type="text/javascript"></script>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        /* 글 수정 화면 function */
        function fn_init_select(orderNum) {
           document.listForm.selectedOrder.value = orderNum;
              document.listForm.action = "<c:url value='/selectOrder.do'/>";
        ...
        function fn_init_link_page(pageNo){
           ...
           document.listForm.action = "<c:url value='/initOrderList.do'/>";
              document.listForm.submit();
        }
    </script>
</head>
...
<div class="container logo" style="float:center;">
    ...
    <form:form commandName="searchVO" id="listForm" name="listForm" method="post"  accept-charset="utf-8" >
        <input type="hidden" name="selectedOrder" />
           ...
           <br/><br/><br/>
           <div class="form-group" style="float:left;">
            <a href="main.do" style="color:black;">메인</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="initProductList.do"style="color:black;">상품리스트</a> &nbsp;&nbsp;>&nbsp;&nbsp;<a>구매내역 리스트</a>
            </div>
           <br/>
    						 <div class="row qnas" style="text-align: center;">
											<h1 class="page-header">구매내역 리스트</h1>
           </div>
           
           <!-- List -->
           <div id="table1">
           <span style="float:left;">총 ${totCnt}개의 구매내역이 있습니다.</span>
              <table class="table table-striped table-bordered table-hover" width="100%" summary="카테고리ID, 케테고리명, 사용여부, Description, 등록자 표시하는 테이블">
                 ...
                 <tr>
                    ...
                    <th align="center" style="text-align:center;">배송비</th>
                    <th align="center" style="text-align:center;">수량</th>
                    <th align="center" style="text-align:center;">결제금액</th>
                    <th align="center" style="text-align:center;">상세보기</th>
                 </tr>
                 
                 <c:forEach var="orderList" items="${orderList}" varStatus="status">
																								<td align="center" class="listtd"><c:out value="${orderList.orderNum}"/>&nbsp;</td>
                        <td align="center" class="listtd"><c:out value="${orderList.prdName}"/>&nbsp;</td>
                        <td align="center" class="listtd"><c:out value="${orderList.shopName}"/>&nbsp;</td>
                        <td align="center" class="listtd"><fmt:formatNumber type="number" maxFractionDigits="3" value="${orderList.prdPriceSale}"/> 원</td>
                        <td align="center" class="listtd"><fmt:formatNumber type="number" maxFractionDigits="3" value="${orderList.delPrice}"/> 원</td>
                        
                        <td align="center" class="listtd"><c:out value="${orderList.prdCnt}"/>&nbsp;</td>
                        <td align="center" class="listtd"><fmt:formatNumber type="number" maxFractionDigits="3" value="${orderList.totalPrice}"/> 원</td>
																								
                     <td align="center" class="listtd" onclick ="event.cancelBubble=true;">    
                        <div id="sysbtn">
														                     <span class="btn btn-default cal-btn">
														                         <a href="javascript:fn_init_select('<c:out value="${orderList.orderNum}"/>');">상세보기</a>
														                      </span>
