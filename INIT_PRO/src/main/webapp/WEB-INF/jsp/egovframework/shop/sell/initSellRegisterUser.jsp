...
function fn_init_productList() {
           ...
           document.detailFormUser.action = "<c:url value='/initProductListUser.do'/>";
           document.detailFormUser.submit();
        }
function fn_init_sellList() {
    document.detailFormUser.action = "<c:url value='/initSellListUser.do'/>";
    document.detailFormUser.submit();
 }
function enterkey() {
...
function fn_init_order() {
	...
	var yn = confirm("구매하시겠습니까?");
	if(yn){
    document.detailFormUser.action = "<c:url value='/addOrder.do'/>";
    document.detailFormUser.submit();
    alert ("구매 완료되었습니다.");
	}
 }
...
<div class="container">
	...
	<div class="container logo" style="float:center;" align="center">
		<a href="/INIT_PRO/" style="float:center;"><img src="${pageContext.request.contextPath}/images/logo.png" width="400" height="80" /></a>
	</div>
...
<div class="row" style="float: left; text-align: center; width:50%;">
      ...
      <li><a href="#"><img src="https://image.a-rt.com/art/product/2020/10/21898_1601963565315.jpg?shrink=580:580" ></a></li> -->
		...
		<input type="hidden" id="shopName" name = "shopName" value="${sellVO.shopName}">
<input type="hidden" id="prdName" name = "prdName" value="${sellVO.prdName}">
		<div class="row productInfo" style="width: 40%; float: right;" >
			...
			<div class="form-group" id="price" style="text-align: left;">
				<label></label><span><input type="hidden" value="${sellVO.prdPrice}" type="number"/></span><span></span>
			...
			<div class="form-group" style="text-align: left;">
				...
				<input type="hidden" id="delName" name = "delName" value="${sellVO.delName}">
			</div>
			<div class="form-group" style="text-align: left;">
...
/*            , enctype: 'multipart/form-data' */
   ...
   , success:function(data) {
			...
			if(!maxPer==0)
			{
				...
				+ '&nbsp;'+numberWithCommas(Math.ceil(prdPriceSale/10)*10)+'</span>&nbsp;원 <input type="hidden" id="prdPriceSale" name="prdPriceSale" value = "'+ Math.ceil(prdPriceSale/10)*10 +'"/>'
			...
			/* $('#prdPriceSale').append('<input type="hidden" id="prdPriceSale" name="prdPriceSale" value="'+ Math.ceil((prdPriceSale)/10)*10 + '"/>'); */
				...
				prdPrice1 = numberWithCommas(prdPrice);
				test = '<label>가격 : &nbsp;</label><span style="font-size:20px;">'+prdPrice1+'</span><span>&nbsp;원</span><input type="hidden" id="prdPriceSale" name="prdPriceSale" value = "'+ prdPrice +'"/>';
