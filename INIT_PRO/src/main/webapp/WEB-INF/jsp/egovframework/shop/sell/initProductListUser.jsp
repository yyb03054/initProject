...
<script src="<c:url value='/js/jqgrid/jquery.contextmenu.js'/>" type="text/javascript"></script>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_init_productList() {
           ...
           document.listForm.action = "<c:url value='/initProductListUser.do'/>";
              document.listForm.submit();
        }
        function fn_init_sellList(prdNum) {
        	document.listForm.selectedId.value = prdNum;
        	document.listForm.pageIndex.value = 1;
           document.listForm.action = "<c:url value='/initSellListUser.do'/>";
              document.listForm.submit();
        }
        function enterkey(){
...
<div class="container logo" style="float:center;">
		<a href="/INIT_PRO/"><img src="${pageContext.request.contextPath}/images/logo.png" width="400" height="80" /></a>
	</div>
	<br/><br/>
           ...
           <span style="float:left;">총 ${totCnt}개의 상품이 검색되었습니다.</span>
              <table class="table table-striped table-bordered table-hover" width="100%" border="0" cellpadding="0" cellspacing="0" summary="카테고리ID, 케테고리명, 사용여부, Description, 등록자 표시하는 테이블">
                 ...
                 <c:forEach var="product" items="${productList}" varStatus="status">
                    ...
                    <td align="center" class="listtd"><img src="${pageContext.request.contextPath}/upload/${product.imgAddress}" width="150" height="150" />
                    </td>
                    </c:if>
                    <c:if test="${product.imgAddress==null }">
                    <td align="center" class="listtd"><img src="${pageContext.request.contextPath}/images/noimg.jpg" width="100" height="100" />
																		  </td></c:if>
																		  <%-- <td align="center" class="listtd">${product.prdNum} --%>
																			 <!-- </td> --><td align="center" class="listtd" style="font-size:18px; vertical-align:middle;">${product.brdName}
																		  </td><td align="center" class="listtd"style="font-size:18px; vertical-align:middle;">${product.prdName}
																		  </td><td align="center" class="listtd"style="font-size:18px; vertical-align:middle;">
